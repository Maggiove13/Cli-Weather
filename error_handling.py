...
def handle_api_errors(response):
    ...
    if response.status_code == 401:
        print(
            "Error: Unauthorized. La clave API no es válida. Por favor verifica tu clave e intenta de nuevo."
        )
    elif response.status_code == 404:
        print("Error: Not Found. Por favor verifica la ortografía e intenta de nuevo.")
